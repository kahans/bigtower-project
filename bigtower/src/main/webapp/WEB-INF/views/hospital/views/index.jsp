...
<head>
	...
	<c:url value="/resources/bootstrap/css/pages/dashboard.css"/>
...
<body>
	...
	<c:if test="${HOSPITALCODE!=null}">
		...
		<li class="dropdown"><a href="<c:url value='/hospital/searchPatient'/>"><button>접수</button></a></li>
		...
		<a href="<c:url value='/government/searchTreat'/>"><button>정부</button></a>
