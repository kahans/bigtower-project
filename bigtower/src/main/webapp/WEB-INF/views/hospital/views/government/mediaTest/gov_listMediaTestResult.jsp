            ...
            <tbody>
            	<c:forEach var="getMediaTest" items="${imageTestList}">
					<tr>
						...
						<td>
							<a onclick="javascript:window.open('/bigtower/government/fileView?filePath=${getMediaTest.goImageTestFilePath}&filePath=${getMediaTest.goImageTestFileName}','','height=0,width=0');" style='cursor:hand'>
