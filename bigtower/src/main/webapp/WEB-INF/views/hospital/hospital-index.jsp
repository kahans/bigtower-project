...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
                    class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="index.jsp">Bootstrap Admin Template </a>
...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li class="active"><a href="ho"><i class="icon-dashboard"></i><span>Dashboard</span> </a> </li>
        <li><a href="reports.jsp"><i class="icon-list-alt"></i><span>Reports</span> </a> </li>
        <li><a href="guidely.jsp"><i class="icon-facetime-video"></i><span>App Tour</span> </a></li>
        <li><a href="charts.jsp"><i class="icon-bar-chart"></i><span>Charts</span> </a> </li>
        <li><a href="shortcodes.jsp"><i class="icon-code"></i><span>Shortcodes</span> </a> </li>
          ...
          <div class="widget">
            ...
            <div class="widget-content">
              <ul class="messages_layout">
                <li class="from_user left"> <a href="#" class="avatar"><img src="templates/hospital/img/message_avatar1.png"/></a>
                ...
                <li class="by_myself right"> <a href="#" class="avatar"><img src="templates/hospital/img/message_avatar2.png"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
                ...
                <li class="from_user left"> <a href="#" class="avatar"><img src="templates/hospital/img/message_avatar2.png"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
      ...
      <div class="row">
                    <div class="span3">
                        ...
                        <ul>
                            ...
                            <li><a href="javascript:;">Responsive jsp5 Portfolio Templates</a></li>
                    ...
                    <div class="span3">
                        ...
                        <ul>
                            ...
                            <li><a href="http://www.egrappler.com;">jsp5 Responsive Tempaltes</a></li>
