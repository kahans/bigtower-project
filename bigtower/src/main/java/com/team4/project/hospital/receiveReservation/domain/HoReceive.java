...
public class HoReceive {
	...
	protected String hoReceiveCode;
	protected String hoHospitalCode;
	protected String hoPatientCode;
	protected String hoStaffId;
	protected String hoTreatSubjectCode;
	protected int hoReceiveStateCode;
	protected String hoReceivePurpose;
	protected String hoReceiveRegistrationDate;
	protected String hoReceiveCompleteDate;
